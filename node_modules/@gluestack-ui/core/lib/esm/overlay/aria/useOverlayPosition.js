...
export function useOverlayPosition(props) {
    var _a, _b, _c;
    let { targetRef, targetRect, overlayRef, placement = 'bottom', offset = 0, crossOffset = 0, isOpen = true, shouldFlip = true, shouldOverlapWithTrigger = false, } = props;
    ...
    let updatePosition = () => __awaiter(this, void 0, void 0, function* () {
        const overlayOffset = yield measureOffset(overlayRef);
        const triggerOffset = targetRect !== null && targetRect !== void 0 ? targetRect : (yield measureOffset(targetRef));
        if (!overlayOffset.width || !overlayOffset.height) {
            requestAnimationFrame(updatePosition);
            return;
        }
        if (!(triggerOffset === null || triggerOffset === void 0 ? void 0 : triggerOffset.width) || !(triggerOffset === null || triggerOffset === void 0 ? void 0 : triggerOffset.height)) {
            if (!targetRect) {
                requestAnimationFrame(updatePosition);
            }
            return;
    ...
    React.useLayoutEffect(() => {
        ...
        targetRect === null || targetRect === void 0 ? void 0 : targetRect.width,
        targetRect === null || targetRect === void 0 ? void 0 : targetRect.height,
        offset,
        shouldFlip,
        crossOffset,
        shouldOverlapWithTrigger,
